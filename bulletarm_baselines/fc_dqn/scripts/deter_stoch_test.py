...
def test(agent, envs, ori_pos, ori_reward):
    ...
    while total < 100:
        ...
        f1=open("./deter_stoch_position_action.txt","a")
        f1.write("index: " + str(object_index) + ", pos: " + str(ori_pos) + ", actions: " + str(actions_star.detach()) + ", ori_reward: " + str(ori_reward) +  ", reward: " + str(rewards) + "\n")
