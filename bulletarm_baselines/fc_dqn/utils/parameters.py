...
env_group.add_argument('--env', type=str, default='object_grasping', help='The training environment')
env_group.add_argument('--robot', type=str, default='kuka', choices=['kuka', 'ur5', 'ur5_robotiq'], help='The robot to use in the environment')
env_group.add_argument('--num_objects', type=int, default=5, help='The number of objects in the environment. When set to -1, will use the default value')
